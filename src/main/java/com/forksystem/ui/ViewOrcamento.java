...
public class ViewOrcamento extends JInternalFrame {
	/**
	 * 
	 */
	...
	public ViewOrcamento() {
		...
		panelMenu.setLayout(gbl_panelMenu);
						...
						btnNovo.setForeground(new Color(255, 255, 255));
								...
								btnNovo.setIcon(new ImageIcon(ViewOrcamento.class.getResource("/img/PNG/archive1.png")));
								...
								panelMenu.add(btnNovo, gbc_btnNovo);
										...
										btnInserirItem.setIcon(new ImageIcon(ViewOrcamento.class.getResource("/img/PNG/forward_alt.png")));
										...
										btnExcluir.setIcon(new ImageIcon(ViewOrcamento.class.getResource("/img/PNG/minus white.png")));
								...
								btnCancelar.setIcon(new ImageIcon(ViewOrcamento.class.getResource("/img/PNG/stop 2.png")));
						...
						btnConfirmar.setIcon(new ImageIcon(ViewOrcamento.class.getResource("/img/PNG/refresh.png")));
						...
						btnImprimir.setIcon(new ImageIcon(ViewOrcamento.class.getResource("/img/PNG/print.png")));
						...
						btnCalcularTotal.setIcon(new ImageIcon(ViewOrcamento.class.getResource("/img/PNG/calculator_add_12952 (1).png")));
		...
		lblBuscar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				TabelaClienteController tb = new TabelaClienteController(ViewOrcamento.this);
				tb.gui.setModal(true);
				tb.gui.setVisible(true);

			}
		});
		lblBuscar.setIcon(new ImageIcon(ViewOrcamento.class.getResource("/img/PNG/search.png")));
