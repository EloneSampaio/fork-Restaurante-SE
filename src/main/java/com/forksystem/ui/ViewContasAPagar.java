...
public class ViewContasAPagar extends JInternalFrame {
	/**
	 * 
	 */
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewContasAPagar frame = new ViewContasAPagar();
	...
	public ViewContasAPagar() {
		...
		JLabel lblTotalDeContas = new JLabel("Contas/Pagas:");
		lblTotalDeContas.setBounds(12, 112, 135, 18);
		...
		lblTotalDeContas_1.setBounds(243, 112, 135, 18);
		...
		lblTotalDeContas_2.setBounds(471, 112, 146, 18);
