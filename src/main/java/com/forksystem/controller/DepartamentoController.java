...
public class DepartamentoController {
	...
	public void adicionar() {
		...
		departamento.setNome(gui.getTextNome().getText());
	...
	public void preencherCampos(Departamento departamento) {
		gui.getTextId().setText(departamento.getId() + "");
		gui.getTextNome().setText(departamento.getNome().toString());
	}
