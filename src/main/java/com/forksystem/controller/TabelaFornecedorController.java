...
public class TabelaFornecedorController {
	...
	public ViewTabelaFornecedor gui;
	...
	public TabelaFornecedorController(JInternalFrame frame) {
		gui = new ViewTabelaFornecedor();
	...
	public void preencherCampos(Fornecedor f) {

		produto.setarFornecedor(f.getId()+"");
