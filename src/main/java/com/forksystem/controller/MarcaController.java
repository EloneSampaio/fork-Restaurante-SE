...
public class MarcaController {
	...
	public void adicionar() {
		...
		marca.setNome(gui.getTextNome().getText());
	...
	public void preencherCampos(Marca marca) {
		gui.getTextId().setText(marca.getId() + "");
		gui.getTextNome().setText(marca.getNome().toString());
	}
