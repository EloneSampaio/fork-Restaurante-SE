...
public class UnidadeController {
	...
	public UnidadeController() {
		...
		dao = Context.getInstace().getContexto().getBean(IUnidade.class);
		initializeTable();
	...
	public void adicionar() {
		...
		unidade.setNome(gui.getTextNome().getText());
	...
	public void preencherCampos(Unidade unidade) {
		gui.getTextId().setText(unidade.getId() + "");
		gui.getTextNome().setText(unidade.getNome().toString());
	}
